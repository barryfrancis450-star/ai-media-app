  ...
  return (
    <div className="p-6 md:p-10">
      ...
      >
        ...
        <p className="text-gray-400 mt-1">Generate realistic voiceovers from text.</p>
      </motion.div>
      ...
      >
        <div className="h-20 w-20 rounded-2xl bg-purple-600/10 border border-purple-700/30 flex items-center justify-center">
          <Mic className="h-9 w-9 text-purple-400 opacity-60" />
        </div>
        <p className="text-lg font-medium text-white/60">Coming soon</p>
        <p className="text-sm text-gray-600 max-w-xs">
          Voice generation is in development. Check back soon.
        </p>
      </motion.div>
    </div>
  );
